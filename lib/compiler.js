...
skeleton = 'var h,text,yield,__cc;__cc={buffer:""},text=function(a){__cc.buffer+=a;return},h=function(a){var b;return b=typeof a=="string"||a instanceof String?b:b.toString(),b.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")},yield=function(a){var b,c;return b=__cc.buffer,__cc.buffer="",a(),c=__cc.buffer,__cc.buffer=b,c};';
